...
if __name__ == "__main__":
    ...
    seq = [
        ...
        [0.1, 0.1, 0.2],      # Move diagonally on the X-Y plane, and a bit up on the Z-axis
        [-0.2, 0.1, 0.0],     # Move to the left along the X-axis, and slightly upward along the Y-axis
        [0.3, -0.1, -0.1],    # Move to the right along the X-axis, down on Y, and slightly down on Z
        [-0.1, -0.2, 0.1],    # Move back along X, downward on Y, and upwards slightly on Z
        [0.0, 0.3, 0.0],      # Move vertically along the Y-axis
        [0.2, 0.0, -0.2],     # Move right along X and down on Z
        [0.1, -0.1, 0.1],     # Small diagonal move along X and Y with slight upwards motion on Z
        [0, 0, -0.1],         # Move downward on Z axis to return
        [-0.3, 0.2, 0.3],     # Move backward and up along X, right on Y, and upwards on Z
    ]
